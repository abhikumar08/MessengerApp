...
package com.example.abhi.myapplication.backend.messaging;
...
public class Messaging extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *
   * @param content the {@link com.example.abhi.myapplication.backend.messaging.model.MessageRecord}
   * @return the request
   */
  public SendMessage sendMessage(com.example.abhi.myapplication.backend.messaging.model.MessageRecord content) throws java.io.IOException {
  ...
  public class SendMessage extends MessagingRequest<Void> {
     ...
     * @since 1.13
     */
    protected SendMessage(com.example.abhi.myapplication.backend.messaging.model.MessageRecord content) {
