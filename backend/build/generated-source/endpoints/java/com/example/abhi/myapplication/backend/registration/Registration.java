 ...
 * on 2016-01-16 at 19:21:31 UTC 
 * Modify at your own risk.
 */

package com.example.abhi.myapplication.backend.registration;
...
public class Registration extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://natural-chiller-111407.appspot.com/_ah/api/";
  ...
  /**
   * Create a request for the method "findMyContacts".
   *
   * This request holds the parameters needed by the registration server.  After setting any optional
   * parameters, call the {@link FindMyContacts#execute()} method to invoke the remote operation.
   *
   * @param phone
   * @return the request
   */
  public FindMyContacts findMyContacts(java.lang.String phone) throws java.io.IOException {
    FindMyContacts result = new FindMyContacts(phone);
    initialize(result);
    return result;
  }

  public class FindMyContacts extends RegistrationRequest<com.example.abhi.myapplication.backend.registration.model.RegistrationRecord> {

    private static final String REST_PATH = "findMyContacts/{phone}";

    /**
     * Create a request for the method "findMyContacts".
     *
     * This request holds the parameters needed by the the registration server.  After setting any
     * optional parameters, call the {@link FindMyContacts#execute()} method to invoke the remote
     * operation. <p> {@link FindMyContacts#initialize(com.google.api.client.googleapis.services.Abstr
     ...
     * @since 1.13
     */
    protected FindMyContacts(java.lang.String phone) {
      super(Registration.this, "POST", REST_PATH, null, com.example.abhi.myapplication.backend.registration.model.RegistrationRecord.class);
      this.phone = com.google.api.client.util.Preconditions.checkNotNull(phone, "Required parameter phone must be specified.");
    }

    @Override
    public FindMyContacts setAlt(java.lang.String alt) {
      return (FindMyContacts) super.setAlt(alt);
    }

    @Override
    public FindMyContacts setFields(java.lang.String fields) {
      return (FindMyContacts) super.setFields(fields);
    }

    @Override
    public FindMyContacts setKey(java.lang.String key) {
      return (FindMyContacts) super.setKey(key);
    }

    @Override
    public FindMyContacts setOauthToken(java.lang.String oauthToken) {
      return (FindMyContacts) super.setOauthToken(oauthToken);
    }

    @Override
    public FindMyContacts setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (FindMyContacts) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public FindMyContacts setQuotaUser(java.lang.String quotaUser) {
      return (FindMyContacts) super.setQuotaUser(quotaUser);
    }

    @Override
    public FindMyContacts setUserIp(java.lang.String userIp) {
      return (FindMyContacts) super.setUserIp(userIp);
    }
    ...
    public FindMyContacts setPhone(java.lang.String phone) {
      this.phone = phone;
      return this;
    }

    @Override
    public FindMyContacts set(String parameterName, Object value) {
      return (FindMyContacts) super.set(parameterName, value);
    }
  }
  ...
  public class ListDevices extends RegistrationRequest<com.example.abhi.myapplication.backend.registration.model.CollectionResponseRegistrationRecord> {
    ...
    protected ListDevices(java.lang.Integer count) {
      super(Registration.this, "GET", REST_PATH, null, com.example.abhi.myapplication.backend.registration.model.CollectionResponseRegistrationRecord.class);
   ...
   *
   * @param content the {@link com.example.abhi.myapplication.backend.registration.model.RegistrationRecord}
   * @return the request
   */
  public Register register(com.example.abhi.myapplication.backend.registration.model.RegistrationRecord content) throws java.io.IOException {
  ...
  public class Register extends RegistrationRequest<Void> {
     ...
     * @since 1.13
     */
    protected Register(com.example.abhi.myapplication.backend.registration.model.RegistrationRecord content) {
      super(Registration.this, "POST", REST_PATH, content, Void.class);
    }
